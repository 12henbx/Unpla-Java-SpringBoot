...
//    public Mono<Response<WasteGetToTransactionResponse>> GetWasteTransaction(@RequestBody WasteGetToTransactionRequest transactionRequest) {
//
//        return commandExecutor.execute(GetWasteToTransactionCommand.class, transactionRequest)
//                .map(Response::ok)
